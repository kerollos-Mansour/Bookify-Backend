...
app.use(cors({
  origin: ['https://bookify-dashboard-kappa.vercel.app', 'https://bookify-react-git-main-mohamed-sabry-avs-projects.vercel.app', 'http://localhost:5173', 'http://localhost:3000', 'http://localhost', 'http://localhost:80'],
  credentials: true
}));
